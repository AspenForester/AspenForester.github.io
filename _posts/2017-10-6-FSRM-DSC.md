...
Certainly, a full defense includes end-user education, proper application of user rights to file and folder resources, and good anti-malware protection.  But disabling a ransomware attack vector is a significant defense.
...
One last piece of the puzzle before we get to the code: I wasn't naive enough to think that a few names and extensions was all it would take to provide any sort of protection.  I did a few Google searches and found that [fsrm.experiant.ca](https://fsrm.experiant.ca/) was curating a list of filenames and extensions that had been involved in ransomware attacks.  To top it off, that list was available in json form.
...
As an aside, Experiant's script breaks the filelist string into 4K chunks, but doesn't provide an explanation for it, nor do I see any technical need.
